...
class ModelPaymentGOPCOD extends Model
{
	public function getMethod($address, $total)
	{
		if($this->config->get('GOP_COD_status'))
		{
			...
			$shipping_method_status = $this->config->get('GOP_COD_' . $shipping_method . '_status');

			if($shipping_method_status == 0)
			{
				$shipping_method_status = $this->config->get('GOP_COD_default_status');
			}
			else
			{
			...
			{
				$shipping_geo_zone = $this->config->get('GOP_COD_' . $shipping_method . '_shipping_geo_zone');

				if($shipping_geo_zone == 0)
				{
					$shipping_geo_zone = $this->config->get('GOP_COD_default_shipping_geo_zone');
				}
				else
				{
				...
				if($shipping_method_geo_zone_id == 0)
				{
					...
					if(count($zone_to_geo_zone_results) > 1)
					{
						...
						{
							$shipping_method_geo_zone_status = $this->config->get('GOP_COD_' . $shipping_method . '_' . $zone_to_geo_zone_result['geo_zone_id'] . '_' . $customer_group_id . '_status');

							if($shipping_method_geo_zone_status == 0)
							{
								$shipping_method_geo_zone_status = $this->config->get('GOP_COD_default_' . $zone_to_geo_zone_result['geo_zone_id'] . '_' . $customer_group_id . '_status');
							}
							else
							{
				...
				$shipping_method_geo_zone_status = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_status');

				if($shipping_method_geo_zone_status == 0)
				{
					$shipping_method_geo_zone_status = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_status');
				}
				else
				{
					$shipping_method_geo_zone_status = $shipping_method_geo_zone_status - 1;
				...
				{
					//Shipping Sort Order
					$shipping_method_sort_order = $this->config->get('GOP_COD_' . $shipping_method . '_sort_order');

					if($shipping_method_sort_order == "")
					{
						$shipping_method_sort_order = $this->config->get('GOP_COD_default_sort_order');
					}
					...
					$shipping_method_tax_class_id = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_tax_class_id');

					if($shipping_method_tax_class_id == 0)
					{
						$shipping_method_tax_class_id = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_tax_class_id');
					}
					...
					$shipping_method_order_status_id = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_status_id');

					if($shipping_method_order_status_id == 0)
					{
						$shipping_method_order_status_id = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_status_id');
					}

					//Shipping Geo Zone Method
					$shipping_method_method = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_method');

					if($shipping_method_method == 0)
					{
						$shipping_method_method = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_method');
					}
					else
					{
					...
					if($shipping_method_method == 0)
					{
						$shipping_method_flat = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_flat');

						if($shipping_method_flat == "")
						{
							$shipping_method_flat = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_flat');
						}
						...
						$shipping_method_flat_currency = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_flat_currency');

						if($shipping_method_flat_currency == 0)
						{
							$shipping_method_flat_currency = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_flat_currency');
						}
					...
					{
						$shipping_method_percent = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_percent');

						if($shipping_method_percent == "")
						{
							$shipping_method_percent = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_percent');
						}
						...
						$cost = ($this->tax->calculate($this->getTotal(), $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_tax_class_id'), $this->config->get('config_tax')))*($shipping_method_percent/100);
					}
					else
					{
						$shipping_method_custom = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_custom');

						if($shipping_method_custom == "")
						{
							$shipping_method_custom = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_custom');
						}
					...
					//Enable Rule
					$enable_rule = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_enable_rule');

					if($enable_rule == "")
					{
						$enable_rule = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_enable_rule');
					}
					...
					//Order Total
					$shipping_method_order_total = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_total');

					if($shipping_method_order_total == 0)
					{
						$shipping_method_order_total = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_total');
					}
					else
					{
					...
					$shipping_method_order_total_sort_order = $this->config->get('GOP_COD_' . $shipping_method . '_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_total_sort_order');

					if($shipping_method_order_total_sort_order == "")
					{
						$shipping_method_order_total_sort_order = $this->config->get('GOP_COD_default_' . $shipping_method_geo_zone_id . '_' . $customer_group_id . '_order_total_sort_order');
					}
					...
					if($method_enabled)
					{
						...
						if($title == null)
						{
							$this->load->language('payment/GOP_COD');
