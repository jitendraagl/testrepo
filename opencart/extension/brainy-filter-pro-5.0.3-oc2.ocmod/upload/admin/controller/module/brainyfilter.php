<?php
/**
 * Brainy Filter Pro 5.0.3, February 18, 2016 / brainyfilter.com
...
class ControllerModuleBrainyFilter extends Controller {
    ...
    public function install() {
        ...
        $this->model_module_brainyfilter->createProductAttrValueTable();
        $this->model_module_brainyfilter->createTaxRateTable();
        $this->model_module_brainyfilter->createFilterTable();
        $this->model_module_brainyfilter->fillCacheTable();
        $this->model_module_brainyfilter->fillTaxRateTable();
        
        $this->model_module_brainyfilter->addDefaultLayout();
        
        $defaultLayout = $this->model_module_brainyfilter->getDefaultLayout();
    ...
    public function uninstall() {
        ...
        $this->model_module_brainyfilter->dropProductAttrValueTable();
        $this->model_module_brainyfilter->dropTaxRateTable();
        $this->model_module_brainyfilter->dropFilterTable();
    ...
    {
        $this->load->model('module/brainyfilter');
        $this->model_module_brainyfilter->cacheProductProperties($productId);
    }
    
    public function eventDeleteProduct($productId) 
    {
        $this->load->model('module/brainyfilter');
        $this->model_module_brainyfilter->deleteProductProperties($productId);
    }
    ...
    public function eventEditReview($reviewId)
    {
        ...
        $this->model_module_brainyfilter->cacheProductProperties($review['product_id']);
    }
    ...
    public function index()
    {
        ...
        $this->_data['attributes'] = $this->model_module_brainyfilter->getAttributes();
        
        $this->_data['filters'] = $this->model_module_brainyfilter->getFilters();
        
	    $this->_data['options'] = $this->model_module_brainyfilter->getOptions();
        
        $this->_data['categories'] = $this->model_module_brainyfilter->getCategories();
    ...
    private function _saveSettings($data) 
    {
        ...
        else 
        {
            ...
            if ($data['layout_enabled']) {
                ...
                $this->model_module_brainyfilter->editLayoutModule($lModule);
            } else {
                $this->model_module_brainyfilter->deleteLayoutModule($moduleId);
            }
